...
class Client(Node):
    ...
    def find_value(self, ask_to: DHTNode, key: str) -> SimpyProcess:
    ...
    def store_value(self, ask_to: DHTNode, key: str, value: int) -> SimpyProcess:
        ...
        if not timeout.processed:
            ...
            self.log(f"Request for  store key {key} : value {value} timed out", level=logging.WARNING)